...
def canonical_pairs_below_t(sorted_residue, content, threshold, log):
    total_canonical ={}
    canonical = {}
    counter1 = 0
    ...
    log.write('Canonical pairs below the threshold is extracting... ')
    return total_canonical

#*******************************************************
# Extract the "Other pairs" from the json file.
def other_pairs_below_t(sorted_residue, content, threshold, log):
    total_other_pairs = {}
    other = {}
    counter1 = 0
    ...
    log.write('Other pairs below the threshold is extracting... ')
    return total_other_pairs


#*******************************************************
# Extract the "base-phosphate" from the json file.
def base_phosphate_below_t(sorted_residue, content, threshold, log):
    ...
    log.write('Base-phosphate below the threshold is extracting... ')
    return total_base_phosphate

#*******************************************************
# Extract the "phosphate-base" from the json file.
def phosphate_base_below_t(sorted_residue, content, threshold, log):
    ...
    log.write('Phosphate-base below the threshold is extracting... ')
    return total_phosphate_base


#*******************************************************
def stacking_1_below_t(sorted_residue, content, threshold, log):
    total_stacking_1 = {}
    stack_1 = {}
    counter1 = 0
    for link in content['links']:
    ...
    log.write('Stacking >> below the threshold is extracting... ')
    return total_stacking_1

#*******************************************************
# Extract the "stacking <<" from the json file.
def stacking_2_below_t(sorted_residue, content, threshold, log):
    total_stacking_2 = {}
    stacking_2 = {}
    counter1 = 0
    for link in content['links']:
...
#*******************************************************
# Extract the "stacking <>" from the json file.
def stacking_3_below_t(sorted_residue, content, threshold, log):
    total_stacking_3 = {}
    stacking_3 = {}
    counter1 = 0
    for link in content['links']:
...
#*******************************************************
# Extract the "stacking ><" from the json file.
def stacking_4_below_t(sorted_residue, content, threshold, log):
    total_stacking_4 = {}
    stacking_4 = {}
    counter1 = 0
    for link in content['links']:
